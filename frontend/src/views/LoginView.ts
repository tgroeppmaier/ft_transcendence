...
export function LoginView() {
  ...
  container.innerHTML = `
    ...
    <div class="mt-6 border-t pt-6">
      ...
      <a href="/api/auth/google" class="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition flex items-center justify-center gap-2">
