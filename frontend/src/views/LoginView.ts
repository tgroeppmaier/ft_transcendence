...
export function LoginView() {
	...
	<input type="text" name="login" required pattern="[a-zA-Z0-9_]+" title="Only letters, numbers and underscore" minlength="3" maxlength="20" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
	</div>
	<div>
